...
import (
	...
	"github.com/notableimmor/gromit/policy"
...
var syncSubCmd = &cobra.Command{
	...
	Long: `Policies are driven by a config file. The config file models the variables of all the repositories under management. See https://github.com/notableimmor/gromit/tree/master/policy/config.yaml.
